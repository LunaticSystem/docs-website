...
<Callout variant="important">
  ...
  Also it is important to note that the only MQ Engine supported by this integration is the ActiveMQ engine. If you need to get metrics from your AWS Rabbit MQ instance(s) we advise looking at our [RabbitMQ Integration](https://docs.newrelic.com/docs/infrastructure/host-integrations/host-integrations-list/rabbitmq-monitoring-integration/) or configuring Cloudwatch Metric Streams.
</Callout>
